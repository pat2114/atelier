...
const APPEND_SYSTEM = `You are an autonomous repair agent for a Jarvis-shell codebase you have been dropped into. Your task is to implement a specific fix described in a repair plan.
